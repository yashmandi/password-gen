          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="lg:py-24">
              ...
              <p className="mt-4 text-gray-300">
                Easily store and manage all your passwords in one place with our <br /><span className="font-bold text-lg text-indigo-400">PassPrompt Password Manager</span>. Protect
