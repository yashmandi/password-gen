    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div>
        <p className="text-3xl pt-16 font-bold text-center mt-10 text-white">
          Instantly generate a strong, random<br />
          password with <span className="text-[#766cf6] hover:text-indigo-400 font-extrabold  transition cursor-default">PassGen</span>🔐
        </p>
